...
from bbabam.utils.http_request_randomizer.requests.proxy.requestProxy import (
    RequestProxy,
)
    ...
    def get_NaverPlace(self, location, name):
        ...
        try:
            ...
            for review in reviews:
                txt.append(
                    review.find("span", attrs={"class": "nWiXa"}).get_text()[1:-2]
                )
        except:
            txt.append(None)
        # 기타 부가 정보
...
class TwitCrawler:
    def __init__(self):
        ...
        self.ACCOUNT = {"id": "teamtripbuilder@gmail.com", "pw": "unist2021!"}
