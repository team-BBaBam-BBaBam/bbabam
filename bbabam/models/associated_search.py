...
2. Output should be formed as [{"Keyword1": ["Question1-1, Question1-2, Question1-3..."]}, {"Keyword2": ["Question2-1, Question2-2, Question2-3..."]}, ...]
...
class AssoSearchGenerator(ChatModel):
    def __init__(
        ...
        super().__init__(
            model_type, ASSO_SEARCH_PROMPT, temperature, stable
        )
