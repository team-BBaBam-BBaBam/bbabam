...
PLACE_DATA_EXTRACTOR_PROMPT = """Two Information is provided for you : Traveler Questions, and the Answer of Traveler Questions.
...
Your task is to result in place data. If specific place data in South Korea has drawn in the answer of Traveler Questions and you would decide that the Traveler Questions contains the needs about knowing place data, you should output the list of place name(such as landmarks name, shopping mall, restaurants... and all can be associated with travel).
...
class PlaceDataExtractor(ChatModel):
    def __init__(
        ...
        super().__init__(model_type, PLACE_DATA_EXTRACTOR_PROMPT, temperature, stable)
